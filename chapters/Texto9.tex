...
\SetWatermarkText{Texto 9 - Oceanografia}
...
\pdfinfo{%
  ...
  /Keywords (Intro oceanografia, texto 9)}
...
\begin{document}
  ...
  \vspace{3ex}
    ...
    \begin{itemize}
      \item[a)] Capítulo 10 (Biological Productivity in the Oceans).
