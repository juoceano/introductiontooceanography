...
%\vspace{1cm}
  ...
  \begin{tikzpicture}[x=0.90cm, y=0.90cm]
    ...
    % y-label.
    \draw[black] (-1, 2) node[anchor=south, rotate=90] {fathoms};
    % y-tickslabels.
    ...
    % x-labels.
    \draw[black] ( 0, 5) node[anchor=south west] {West};
    \draw[black] (24, 5) node[anchor=south west] {East};
    \draw[black] (13, 5) node[anchor=south] {North Atlantic Ocean (nautical miles};
    % x-tickslabels.
