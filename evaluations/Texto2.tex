...
\SetWatermarkText{Texto 2 - Oceanografia}
...
\pdfinfo{%
  ...
  /Keywords (Intro oceanografia, texto 2)}
...
\begin{document}
  ...
  \vspace{3ex}
    ...
    \section{Texto 2 - Oceanografia}

    \noindent

    DTeixeira, W.; Toledo, M.C.M.de; Fairchild, T. R.; Taioli, F. (2003). Decifrando a Terra. 1 edição. São Paulo: Oficina de Textos, 597p.

    \begin{itemize}
      \item[a)] Capítulo 1 - tópicos 1.1 ao 1.4 inclusive;
      
      \item[b)] Capítulo 4 - tópicos 4.3, 4.5 - 4.9, 4.12-4.14 inclusive;
      
      \item[c)] Capítulo 5 - tópicos 5.1 - 5.3.1 inclusive;
    \end{itemize}
