...
\SetWatermarkText{Redação - Oceanografia}
...
\pdfinfo{%
  ...
  /Keywords (Intro oceanografia, redação)}
...
\begin{document}
  ...
  \vspace{3ex}
    ...
    \section{Redação - Oceanografia}

    \noindent
	Escrva uma redação respondendo as questões abaixo.
	
     \begin{itemize}
      \item[a)] por que você escolheu o curso de Oceanografia?
      \item[b)] quais as suas expectativas com relação ao curso de Oceanografia?
      \item[c)] quais as suas expectativas com relação à disciplina Introdução à Oceanografia?
     \end{itemize}
