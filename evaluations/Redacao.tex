...
\begin{document}
  ...
  \vspace{3ex}
    ...
    Escreva uma redação respondendo:

    \begin{itemize}
      \item[a)] por que você decidiu cursar Oceanografia?
      \item[b)] quais as suas expectativas com relação ao curso de Oceanografia?
      \item[c)] quais as suas perspectivas com relação à disciplina Introdução à Oceanografia?
    \end{itemize}
