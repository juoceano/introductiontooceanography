...
\begin{document}
  ...
  \vspace{3ex}
    ...
    a) por que você decidiu cursar Oceanografia?
    
    b) quais as suas expectaticas com relação ao curso de Oceanografia?
    
    c) quais as suas perspectivas com relação à disciplina Introdução à Oceanografia?
